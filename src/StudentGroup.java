...
public class StudentGroup implements StudentArrayOperation {
	...
	public Student getStudent(int index) {
		// Add your implementation here
		if(index<0 || index > students.length){throw new IllegalArgumentException(" index Error ");}
	...
	public void setStudent(Student student, int index) {
		int i;
		// Add your implementation here
		if(student==null || index <0 || index > students.length){throw new IllegalArgumentException("Error");}
		else{
		ArrayList<Student> al=new ArrayList<Student>();
		for(i=0;i<students.length;i++)
		{
			if(i<index){al.add(getStudent(i));}
			else{break;}
		}
		al.add(student);
	for(;i<students.length;i++){al.add(getStudent(i));}
	...
	public void addFirst(Student student) {
		// Add your implementation here
		if(student==null){throw new IllegalArgumentException("Error");}
		else{
		ArrayList<Student> al=new ArrayList<Student>();
		al.add(student);
		for(i=0;i<students.length;i++)
	...
	public void remove(int index) {
		// Add your implementation here
		if(index<0 || index > students.length){throw new IllegalArgumentException("Error"); }
		else{
		List<Student> al=new ArrayList<Student>();
		for(i=0;i<index;i++)
		{
	...
	public Student[] getByBirthDate(Date date) {
		...
		else{ArrayList<Student> al=new ArrayList<Student>(); 
	...
	public Student[] getBetweenBirthDates(Date firstDate, Date lastDate) {
		// Add your implementation here
	if(firstDate==null || lastDate==null){throw new IllegalArgumentException("Error");}
		else{ArrayList<Student> al=new ArrayList<Student>();
		for(Student s:this.students){
	...
	public int getCurrentAgeByDate(int indexOfStudent) {
		// Add your implementation here
		if(indexOfStudent==0){throw new IllegalArgumentException("Error"); }else{
		Date d=new Date();
		int age=students[indexOfStudent].getBirthDate().getYear()- d.getYear();
		return age;
		}}
	...
	public Student[] getStudentsByAge(int age) {
		...
		{
			 a=s.getBirthDate().getYear()- d.getYear();
			 if(a==age){al.add(s);}
		}
